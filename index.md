...
<table class="full-width">
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=9.3 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=32.27 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=17.35 %}
  </tr>
  <tr>
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=1 percentage=16.51 %}
    <td>2020</td>
  </tr>
  <tr>
    <td>
    ...
    {% include progress-cell.html rowspan=1 percentage=8.83 %}
    <td>2019</td>
  </tr>
  <tr>
    <td>
    ...
    <td><code>P</code></td>
    <td>Pie</td>
    {% include progress-cell.html rowspan=1 percentage=6 %}
    <td>2018</td>
  </tr>
  <tr>
    <td rowspan="2">
    ...
    {% include progress-cell.html rowspan=1 percentage=2.1 %}
    <td rowspan="2">2017</td>
  </tr>
  <tr>
    <td>Level 26 <span class="subversion">Android 8.0</span></td>
    <td><code>O</code></td>
    {% include progress-cell.html rowspan=1 percentage=2.85 %}
  </tr>
  <tr>
    <td rowspan="2">
    ...
    {% include progress-cell.html rowspan=1 percentage=0.44 %}
    <td rowspan="2">2016</td>
  </tr>
  <tr>
    <td>Level 24 <span class="subversion">Android 7.0</span></td>
    <td><code>N</code></td>
    {% include progress-cell.html rowspan=1 percentage=1.46 %}
  </tr>
  <tr>
    <td>
    ...
    <td><code>M</code></td>
    <td>Marshmallow</td>
    {% include progress-cell.html rowspan=1 percentage=1.35 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=1 percentage=0.83 %}
  </tr>
  <tr>
    <td>Level 21 <span class="subversion">Android 5.0</span></td>
    <td><code>LOLLIPOP</code>, <code>L</code></td>
    {% include progress-cell.html rowspan=2 percentage=0.19 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=3 percentage=0.26 %}
  </tr>
  <tr>
    <td>
      Level 19
...
<tr class="table-notes"><td colspan="3">
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=3 percentage=0.02 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=3 percentage=0.01 %}
  </tr>
  <tr>
