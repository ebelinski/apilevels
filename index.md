...
<table class="full-width">
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=16.3 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=42.5 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=59.5 %}
  </tr>
  <tr>
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=1 percentage=75.7 %}
    <td>2020</td>
  </tr>
  <tr>
    <td>
    ...
    {% include progress-cell.html rowspan=1 percentage=84.5 %}
    <td>2019</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=99.5 %}
  ...
  <tr class="table-notes"><td colspan="3">
    <ul>
      ...
      <li><a href="https://developer.android.com/jetpack/androidx">AndroidX</a> libraries <a href="https://developer.android.com/jetpack/androidx/versions/all-channel#april_3_2024">require</a> a <code>minSdk</code> of 21 or higher since April 2024.</li>
