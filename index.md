...
<table class="full-width">
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=2 percentage=20.0 %}
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=3 percentage=40.8 %}
  </tr>
  <tr>
  ...
  <tr>
    ...
    {% include progress-cell.html rowspan=1 percentage=61.9 %}
    <td>2020</td>
  </tr>
  <tr>
    <td>
    ...
    {% include progress-cell.html rowspan=1 percentage=78.5 %}
    <td>2019</td>
  </tr>
  <tr>
    <td>
  ...
  <tr class="table-notes"><td colspan="3">
    <ul>
      ...
      <li>Google Play services <a href="https://android-developers.googleblog.com/2023/07/google-play-services-discontinuing-updates-for-kitkat.html">do not support Android versions</a> below API level 21.</li>
    </ul>
  </td></tr>
  <tr>
